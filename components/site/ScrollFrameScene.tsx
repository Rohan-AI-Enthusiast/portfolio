...
export function ScrollFrameScene() {
  ...
  // Frame transforms across the whole scene
  ...
  // Image crossfade (portrait -> placeholder) around mid scroll
  ...
  return (
    <div ref={sceneRef} className="relative">
      ...
      {/* Scroll controller region */}
      <section className="relative h-[170vh]">
        {/* Sticky stage that holds the travelling frame */}
        <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden">
          {/* Floating dot accent like the template */}
          ...
          <div className="relative h-full w-full max-w-6xl px-5">
            ...
            >
              <div
                className="relative w-[280px] overflow-hidden rounded-[28px] bg-white shadow-[0_40px_120px_rgba(0,0,0,0.12)] ring-1 ring-black/10 md:w-[360px]"
              ...
              >
                <div className="relative aspect-[3/4] w-full">
                  ...
                  {/* Alt layer, code-only, no image files required */}
